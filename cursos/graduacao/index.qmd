...
listing:
  ...
  contents:
    - projetos-estudantes
    - "!projetos-estudantes/index.qmd"
    - "!projetos-estudantes/enviar.qmd"
  sort: "date desc"
  template: ../../cards.ejs
---
...
A formação combina uma base sólida em **matemática, probabilidade e
inferência** com forte componente computacional (programação, bancos de
dados e aprendizado de máquina) e com aplicações reais em projetos,
estágios e parcerias com a comunidade.
...
Trabalhos desenvolvidos pelos nossos estudantes, do mais recente ao mais
antigo. Veja todos em [Projetos dos Estudantes](projetos-estudantes/index.qmd)
ou [envie o seu projeto](projetos-estudantes/enviar.qmd).
