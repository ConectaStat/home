---
pagetitle: "Conexão Estatística | Ciência, Estatística e Conexão"
page-layout: custom
section-divs: false
editor: source
sidebar: false
...
repo-actions: false
description: |
  Conexão Estatística - Ciência, Estatística e Conexão. Departamento de Estatística da UFLA.
image: images/logo_ufla_transparente.png
listing:
  - id: noticias
...
<!-- ============================================================= -->
<!--  HERO - só a ilustração + tagline em fonte mono (estilo       -->
<!--  prompt: Ciência/ Estatística/ Conexão, com cursor piscando)  -->
<!-- ============================================================= -->
```{=html}
    ...
    <div class="hero-grid">
      <div class="hero-text">
        <p class="hero-tagline">
          ...
          <span>Conexão<span class="hero-cursor" aria-hidden="true"></span></span>
        </p>
      </div>
...
[Manchetes e novidades do Departamento de Estatística]{.sec-sub}
